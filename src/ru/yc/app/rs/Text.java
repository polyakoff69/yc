...
public class Text extends ListResourceBundle {
    public Object[][] getContents() {
        return new Object[][] {
            ...
            { "no_file", "File is not specified" },
            { "no_file2", "Folder is specified" },
            { "no_file_handlers_e", "There are no file editors associations specified in the application options" },
            { "not_match_handler_e", "Unable to match corresponding editor for selected file" },
            { "no_file_handlers_v", "There are no file viewers associations specified in the application options" },
            { "not_match_handler_v", "Unable to match corresponding viewer for selected file" },
            { "no_cmd_e", "No command specified for editor execution in the application settings" },
            { "no_cmd_v", "No command specified for viewer execution in the application settings" },
